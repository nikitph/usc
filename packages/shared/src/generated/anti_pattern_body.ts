...
export const AntiPatternBodySchema = z.object({
  "id": z.string().min(1),
  "name": z.string().min(1),
  "domain": z.string().min(1),
  "failureMode": z.string().min(1),
  "motifSignature": z.array(z.string().min(1)).min(1),
  "triggeringPatternIds": z.array(z.string().min(1)),
...
export type AntiPatternBody = z.infer<typeof AntiPatternBodySchema>;
